...
func (r *Repository) GetByID(ctx context.Context, id int64) (Business, error) {
	var b Business
	err := r.db.QueryRow(ctx, `
		SELECT id, uuid, provider_id, name, category, description, logo_url, is_active, created_at, updated_at
		FROM businesses
		WHERE id = $1
	`, id).Scan(
		&b.ID, &b.UUID, &b.ProviderID, &b.Name, &b.Category,
...
func (r *Repository) GetByUUID(ctx context.Context, id uuid.UUID) (Business, error) {
	var b Business
	err := r.db.QueryRow(ctx, `
		SELECT id, uuid, provider_id, name, category, description, logo_url, is_active, created_at, updated_at
		FROM businesses
...
func (r *Repository) ListByProviderID(ctx context.Context, providerID int64, page, perPage int) ([]Business, int, error) {
...
func (r *Repository) Update(ctx context.Context, id int64, req BusinessUpdate) (Business, error) {
	var b Business
	err := r.db.QueryRow(ctx, `
...
func (r *Repository) UpdateLogoURL(ctx context.Context, id int64, logoURL string) (Business, error) {
	var b Business
	err := r.db.QueryRow(ctx, `
...
func (r *Repository) GetBusinessProviderID(ctx context.Context, businessID int64) (int64, error) {
