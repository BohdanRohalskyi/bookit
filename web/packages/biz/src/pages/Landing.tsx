...
function InstagramIcon() {
  return (
    <svg className="size-5" viewBox="0 0 18 18" fill="currentColor">
      <path fillRule="evenodd" clipRule="evenodd" d="M9 0C6.556 0 6.25.01 5.29.054 4.332.099 3.677.25 3.105.473a4.902 4.902 0 00-1.772 1.153A4.902 4.902 0 00.18 3.398C-.042 3.97-.194 4.625-.238 5.583-.283 6.542-.293 6.849-.293 9.293s.01 2.75.055 3.71c.044.958.196 1.613.419 2.185a4.902 4.902 0 001.153 1.772 4.9 4.9 0 001.772 1.152c.572.223 1.227.375 2.185.42.96.044 1.267.054 3.71.054s2.75-.01 3.71-.055c.958-.044 1.613-.196 2.185-.419a4.9 4.9 0 001.772-1.152 4.9 4.9 0 001.152-1.772c.223-.572.375-1.227.42-2.185.044-.96.054-1.267.054-3.71s-.01-2.75-.055-3.71c-.044-.958-.196-1.613-.419-2.185A4.9 4.9 0 0016.435 1.18 4.9 4.9 0 0014.663.027C14.091-.196 13.436-.348 12.478-.393 11.518-.437 11.211-.447 8.768-.447L9 0zm-.22 1.621c.208 0 .44 0 .696 0 2.386 0 2.669.009 3.617.052.873.04 1.347.186 1.663.308.418.162.716.356 1.03.67.313.313.508.612.67 1.03.122.315.268.79.308 1.663.043.948.052 1.231.052 3.616s-.009 2.668-.052 3.616c-.04.873-.186 1.347-.308 1.663a2.77 2.77 0 01-.67 1.029 2.77 2.77 0 01-1.03.67c-.315.122-.79.268-1.662.308-.948.043-1.232.052-3.617.052-2.386 0-2.669-.009-3.617-.052-.873-.04-1.347-.186-1.662-.309a2.773 2.773 0 01-1.03-.67 2.773 2.773 0 01-.67-1.029c-.123-.316-.268-.79-.308-1.663-.043-.948-.052-1.23-.052-3.617 0-2.386.009-2.668.052-3.616.04-.873.185-1.347.308-1.663.162-.418.356-.717.67-1.03.313-.313.611-.508 1.03-.67.315-.123.789-.268 1.662-.308.83-.038 1.151-.05 2.82-.051v.002zm5.59 1.494a1.08 1.08 0 100 2.16 1.08 1.08 0 000-2.16zM9 4.378a4.622 4.622 0 100 9.244A4.622 4.622 0 009 4.378zm0 1.621a3 3 0 110 6 3 3 0 010-6z" />
    </svg>
  )
}
